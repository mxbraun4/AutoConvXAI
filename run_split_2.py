#!/usr/bin/env python3
"""
Evaluate split 2 independently.
"""
...
def main():
    ...
    # Setup
    split_file = 'splits/split_2.json'
    results_dir = 'results_split_2'
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"Starting evaluation of split 2...")
    ...
    print(f"Evaluating {len(test_cases)} test cases in split 2")
    ...
    # Print summary
    print("\n" + "="*50)
    print(f"SPLIT 2 EVALUATION RESULTS")
    print("="*50)
