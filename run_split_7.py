#!/usr/bin/env python3
"""
Evaluate split 7 independently.
"""
...
def main():
    ...
    # Setup
    split_file = 'splits/split_7.json'
    results_dir = 'results_split_7'
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"Starting evaluation of split 7...")
    ...
    print(f"Evaluating {len(test_cases)} test cases in split 7")
    ...
    # Print summary
    print("\n" + "="*50)
    print(f"SPLIT 7 EVALUATION RESULTS")
    print("="*50)
