#!/usr/bin/env python3
"""
Evaluate split 9 independently.
"""
...
def main():
    ...
    # Setup
    split_file = 'splits/split_9.json'
    results_dir = 'results_split_9'
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"Starting evaluation of split 9...")
    ...
    print(f"Evaluating {len(test_cases)} test cases in split 9")
    ...
    # Print summary
    print("\n" + "="*50)
    print(f"SPLIT 9 EVALUATION RESULTS")
    print("="*50)
