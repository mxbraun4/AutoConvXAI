#!/usr/bin/env python3
"""
Evaluate split 8 independently.
"""
...
def main():
    ...
    # Setup
    split_file = 'splits/split_8.json'
    results_dir = 'results_split_8'
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"Starting evaluation of split 8...")
    ...
    print(f"Evaluating {len(test_cases)} test cases in split 8")
    ...
    # Print summary
    print("\n" + "="*50)
    print(f"SPLIT 8 EVALUATION RESULTS")
    print("="*50)
