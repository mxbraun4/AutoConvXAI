#!/usr/bin/env python3
"""
Evaluate split 1 independently.
"""
...
def main():
    ...
    # Setup
    split_file = 'splits/split_1.json'
    results_dir = 'results_split_1'
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"Starting evaluation of split 1...")
    ...
    print(f"Evaluating {len(test_cases)} test cases in split 1")
    ...
    # Print summary
    print("\n" + "="*50)
    print(f"SPLIT 1 EVALUATION RESULTS")
    print("="*50)
