#!/usr/bin/env python3
"""
Evaluate split 10 independently.
"""
...
def main():
    ...
    # Setup
    split_file = 'splits/split_10.json'
    results_dir = 'results_split_10'
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"Starting evaluation of split 10...")
    ...
    print(f"Evaluating {len(test_cases)} test cases in split 10")
    ...
    # Print summary
    print("\n" + "="*50)
    print(f"SPLIT 10 EVALUATION RESULTS")
    print("="*50)
