#!/usr/bin/env python3
"""
Evaluate split 3 independently.
"""
...
def main():
    ...
    # Setup
    split_file = 'splits/split_3.json'
    results_dir = 'results_split_3'
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"Starting evaluation of split 3...")
    ...
    print(f"Evaluating {len(test_cases)} test cases in split 3")
    ...
    # Print summary
    print("\n" + "="*50)
    print(f"SPLIT 3 EVALUATION RESULTS")
    print("="*50)
